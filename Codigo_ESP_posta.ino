...
uint8_t servofunc1 =1;
uint8_t servofunc2 =1;
uint8_t servofunc3 =1;
    ...
    <head>
        ...
        <style>
            ...
            * {
            ...
            body {
                background-image: url("https://scontent.fepa4-1.fna.fbcdn.net/v/t39.30808-6/398422986_122119261064073876_2859396915541067712_n.jpg?_nc_cat=108&ccb=1-7&_nc_sid=3635dc&_nc_ohc=I3NrhsxxiokAX_QZZhw&_nc_ht=scontent.fepa4-1.fna&oh=00_AfBtKWknZ5nlZny1vUKfXQ_bujZQnc7VoHXsFtPHs3M-lQ&oe=65768258");
        ...
        <div class="rowDiv">
            <ul class="ulMenu">
                ...
                <li class="liMenu" id="Bano">
                    <span class="textMenu" data-text="Baño">Bano</span>
                </li>
